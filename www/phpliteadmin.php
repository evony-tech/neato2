<?php
// MODULE_NAME: phpLiteAdmin (http://www.phpliteadmin.org/)
// MODULE_DESC: PHP-based admin tool to manage SQLite2 and SQLite3 databases on the web (default pass set to NEATO)
// MODULE_STATUS: Production - Open Source project
// MODULE_VERSION: 1.9.7.1
//	
